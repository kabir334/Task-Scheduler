...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    //SharedPreferences sharedPreferences= getA.getPreferences("our_data",MODE_PRIVATE);

    private MainActivity context;
    //private history context5;
        ...
        popupMenu.setOnMenuItemClickListener(item -> {
            switch (item.getItemId()) {
                case R.id.menuDelete:
                    SharedPreferences share=context.getSharedPreferences("quit",MODE_PRIVATE);
                    SharedPreferences.Editor edit=share.edit();
                    SimpleDateFormat todays_date=new SimpleDateFormat("dd/MM/yyyy");
                    Date today=new Date();
                    String ajker_tarikh=todays_date.format(today);
                    String s1=ajker_tarikh.substring(0,2);
                    Integer date_int=Integer.parseInt(s1);
                    String date_string=Integer.toString(date_int);
                    String ans=share.getString(date_string,"0");
                    int j=Integer.parseInt(ans);
                    j=j+1;
                    ans=Integer.toString(j);
                    edit.putString(date_string,ans);
                    edit.commit();
                ...
                case R.id.menuComplete:
                    ...
                    SharedPreferences sharedPreferences=context.getSharedPreferences("our_data", MODE_PRIVATE);
                    ...
                    String s2string=Integer.toString(s2int);
                    String result=sharedPreferences.getString(s2string,"0");
                    int i=Integer.parseInt(result);
                    i=i+1;
                    result=Integer.toString(i);
                    editor.putString(s2string,result);
                    editor.commit();
                   // Toast.makeText(context.getApplicationContext(),result,Toast.LENGTH_LONG).show();
                  //  Toast.makeText(context.getApplicationContext(),date_to_string,Toast.LENGTH_LONG).show();
